...
import { clue_color_action, clue_number_action, discard_action, fireworks, getHandForPlayer, initialState, join_action, makeFullDeck, play_action, start_action } from '$lib/components/fireworks';
...
describe('fireworks', () => {
    ...
    it('Can infer basic color play clues', () => {
        ...
        state = fireworks(state, clue_color_action({cluegiver: 1, player: 0, color: "B"}));
        p0hand = getHandForPlayer(state, 0);
    ...
    it('Can infer basic number play clues', () => {
        ...
        state = fireworks(state, clue_number_action({cluegiver: 0, player: 1, value: 2}));
        p1hand = getHandForPlayer(state, 1);
    ...
    it('Can infer deferred color play clues', () => {
        ...
        state = fireworks(state, clue_color_action({cluegiver: 0, player: 1, color: "B"}));
        let p1hand = getHandForPlayer(state, 1);
